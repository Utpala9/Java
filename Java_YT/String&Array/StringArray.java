...
public class StringArray {
    ...
    public static void main(String args []){
       ...
       StringBuffer s = nw StringBuffer("Tiya"); // StringBuffer is a class in java which is used to create mutable strings , we can change the string using StringBuffer class
       ...
       for num1 (int i = 0; i < num1.length; i++){ // length is a property of array which gives the size of the array
